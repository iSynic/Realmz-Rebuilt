...
func run() -> void:
	...
	active_caster.set_known_spells(["classic.spell.field-bolt", "classic.spell.field-fixed", "classic.spell.field-light", "classic.spell.field-rest", "classic.spell.heal-poison", "classic.spell.remove-item", "classic.spell.4308", "classic.spell.1101", "classic.spell.2102", "classic.spell.3102"])
