...
- Integrated stock music retains Castle playlist IDs 1–11 and loads from Godot-imported looping Ogg resources. `classic-application-music.json` records exact module commits and hashes, deterministic OpenMPT/FFmpeg conversion settings, output hashes, durations, and the pinned-MADG-to-later-standard-MOD Outdoor replacement. Custom 1–3 are scenario-owned exact resources; never copy them into the application bank.
