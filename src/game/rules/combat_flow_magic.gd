...
const CombatSpellSelectionType = preload("res://src/game/rules/combat_spell_selection.gd")
...
func _init(flow: RefCounted, rules: ContextType) -> void:
	...
	_rules = rules
	_selection = CombatSpellSelectionType.new(flow, rules)
