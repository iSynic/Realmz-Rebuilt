...
- Imported Providence resource-catalog pictures, icons, sounds, Classic special-land `cicn` overlays, and every map-referenced tileset are compiled as content-addressed package media. A runtime-ready managed asset with the same Classic resource identity replaces the imported preview.
