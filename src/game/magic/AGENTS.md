...
- Physical projectile items admit source-backed specials 0, 7, 28, and 49. Special 7 halves a character target's current movement after a successful monster-fired hit; Castle rebuilds monster movement at activation, so a character-fired Saphron arrow retains damage without a durable monster mutation. Special 28 deals its rolled duration as damage and applies Blind through the shared permanent-condition and accumulation guards. Special 49 replaces rolled damage with current target health plus ten after the ordinary projectile defense gate. Other specials remain explicit.
