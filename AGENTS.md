...
- Push approved public changes directly after required verification; do not create pull requests unless the user requests one. Preserve branch protections and required checks.
