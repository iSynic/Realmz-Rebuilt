...
Automated structural acceptance, gallery-wide visual sign-off, and repository-local clean-clone onboarding are complete. The independent maintainer exercise, ordinary-play campaign walkthroughs, and native macOS certification remain open.
