...
func _test_scene_composition() -> void:
	...
	assert_equal([world_panel.size_flags_horizontal, narrative_well.size_flags_horizontal, party_panel.size_flags_horizontal, (shell.find_child("WorldCommandGrid", true, false) as GridContainer).size_flags_horizontal, (shell.find_child("CommandScroll", true, false) as ScrollContainer).size_flags_vertical, (shell.find_child("CommandGrid", true, false) as GridContainer).size_flags_horizontal], [Control.SIZE_EXPAND_FILL, Control.SIZE_SHRINK_CENTER, Control.SIZE_EXPAND_FILL, Control.SIZE_SHRINK_CENTER, Control.SIZE_EXPAND_FILL, Control.SIZE_SHRINK_CENTER], "the wide footer keeps a bounded narrative measure and centers both command groups in their flexible side panes")
