...
- Terminal reward ownership lasts through every source-ordered reward workspace. Opcode 48's optional fixed treasure is a separately persisted second stage; combat cleanup, the after-message, and VM return occur only after that stage completes.
