...
Begin with [The Realmz Rebuilt Builder's Manual](docs/builders-manual.md). Package/save contracts, Classic fidelity decisions, and architectural records continue in [docs/package-and-save-contracts.md](docs/package-and-save-contracts.md), [docs/fidelity-ledger.md](docs/fidelity-ledger.md), and `docs/adr`. Contribution requirements are in [CONTRIBUTING.md](CONTRIBUTING.md).
