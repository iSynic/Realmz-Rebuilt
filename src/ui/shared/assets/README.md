...
This directory is the application-wide media library used by the shell, workspaces, and algorithmic renderers. It contains exact Classic controls and media, project-owned chrome and map surfaces, dungeon surfaces, fonts, shaders, sounds, music, and the provenance catalogs that identify every selected production asset.
