...
- Compiler evidence: Providence commit `a525e9df0d0619847a5928463eed881ace79152a` retains direct ally monster definitions and packages every referenced map atlas, including a normalized Classic dungeon composition atlas. Its 325-test Rust library gate passes with one audit test ignored. Runtime unit/integration coverage currently passes 768 assertions across nine suites.
- Current AOGM visual/performance evidence: local package hash `737a84e374bfd3b843ce50e8176c648e33e8f68bb5894efb2a8b96693f0204d2` independently validates with 26 media assets. A 960×600 capture at land 0 (48,15) shows coherent package-backed Classic tiles at native 32×32 size, without normal-play topology grids/edge walls/AP/random-region overlays, in the clipped 530×452 map viewport. The view exposes gold passable and muted blocked cardinal cues plus click/hold and arrow/WASD movement. AOGM view construction measured 13–15 ms instead of 146–173 ms before the bounded projection; installed campaign discovery measured 343 ms for six packages, and cold full AOGM validation/construction remains about 8.4–8.8 seconds after Play. The runtime suite passes 768 assertions across nine suites. This does not replace the earlier route package's `live-route` evidence until that route is rerun against the new hash.
