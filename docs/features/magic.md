...
- Follow a submitted cast from `PlayerIntent` through `GameSession` into the field or combat workflow. Rules, target legality, costs, effects, RNG, and saved state never live in the UI.
