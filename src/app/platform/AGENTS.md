...
- `DebugToolsHost` exposes the presentation-only F12 Diagnostics overlay toggle in every build and admits typed mutation commands, event history, and the console only in debug builds.
