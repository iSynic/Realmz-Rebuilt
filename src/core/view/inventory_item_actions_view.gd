...
var split := ActionAvailabilityView.new(&"split_item", false, "Classic split-stack load behavior requires a fidelity decision.")
var join := ActionAvailabilityView.new(&"join_item", false, "Classic join-stack load behavior requires a fidelity decision.")
