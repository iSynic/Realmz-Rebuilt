...
- Large session, combat, application, interaction, and shell scripts were divided once, but 23 files still exceed the final 600-line limit, 91 functions exceed 60 lines, and 35 top-level scripts exceed the final method-count limits.
