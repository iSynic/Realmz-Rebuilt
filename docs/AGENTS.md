...
- `architecture-migration.md` records the completed foundational reorganization, its acceptance boundary, and the continuing no-regression readability ratchets.
