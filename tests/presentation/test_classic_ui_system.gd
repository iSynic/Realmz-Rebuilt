...
func _test_battle_typed_option_contracts() -> void:
	...
	for power: int in range(3, 8): opened_options.append(InteractionRequestValueDecoder.cast_option({"spellId": "classic.spell.1306", "spellName": "Brimstones", "power": power, "cost": power * 2, "targetId": "", "targetName": "All enemies", "targetCurrentHealth": -1, "targetMaximumHealth": -1, "targetMode": "automatic"}, &"spell"))
