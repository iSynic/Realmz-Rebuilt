...
- `capture_classic_ui_gallery.gd` writes representative local frames under ignored `artifacts/ui-gallery/`, including Treasure, Shop, and the combat spellbook at canonical 1280x720 plus selected 800x600 Classic-mode frames; it is visual evidence, not a golden-image test.
