...
- `BankInteraction` renders only supplied pooled, banked, personal, load, Pool/Share, exact-increment, selection, and unavailable-reason facts. It emits Pool, Share, one stable character/denomination transfer, or Done. It never performs bank import/return, recomputes capacity, or turns Done into a deposit.
