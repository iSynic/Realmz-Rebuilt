...
Save v5 and Character Files v2 require each character's exact equipped-instance order so cap- and floor-sensitive equipment effects restore deterministically. Save v1–v4 and Character Files v1 are incompatible; browsing reports them without migration, overwrite, or deletion.
