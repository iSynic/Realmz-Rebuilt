...
func _test_field_spell_workspace() -> void:
	...
	var definition := SpellDefinition.new("classic.spell.field", 1101, "Field Bolt", "A compact field spell description.")
