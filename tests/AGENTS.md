...
- Public exploration and combat workflows own source-backed action-cue event IDs and ordering. Presentation route tests own only explicit workspace-entry cues, same-route suppression, and automatic-route suppression; they do not duplicate simulation sound requests.
