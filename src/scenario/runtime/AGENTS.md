...
- Shop projection preserves Castle's five fixed native stock bands by source slot: Weapons 0–199, Armor 200–399, limb armor 400–599, Magic 600–799, and Supplies 800–999. A sale increments the first active matching item or claims the first empty slot in its Classic identity band; that assignment and quantity are save-owned and immutable package stock remains unchanged.
