...
func _field_content(source: RealmzContent) -> RealmzContent:
	...
	var library := PackageRepository.new().load_bundled_package("res://src/infrastructure/characters/realmz-classic-character-library.realmz2", "realmz-classic-character-library", "e1abb1ec6203b96207af0bbd421d660cc705945bd14355645e09b73bdb8d3afb"); var spells: Array[SpellDefinition] = [bolt, fixed, light, rest, cure, remove_item, heroism, library.content.spell_by_classic_id(1101), library.content.spell_by_classic_id(2102), library.content.spell_by_classic_id(3102)]; for classic_id: int in [1609, 2504, 2609, 2611, 3111, 3112, 3410, 3709, 3711]: spells.append(library.content.spell_by_classic_id(classic_id))
