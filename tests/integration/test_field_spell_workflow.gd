...
func _field_content(source: RealmzContent) -> RealmzContent:
	...
	var library := PackageRepository.new().load_bundled_package("res://src/infrastructure/characters/realmz-classic-character-library.realmz2", "realmz-classic-character-library", "4b207f7d1882178d1d5b16c985adc1388cba176e155267cd9120dfab80753e4f"); items.append(library.content.item_by_classic_id(609)); items.append(library.content.item_by_classic_id(723)); var spells: Array[SpellDefinition] = [bolt, fixed, light, rest, cure, remove_item, heroism, library.content.spell_by_classic_id(1101), library.content.spell_by_classic_id(2102), library.content.spell_by_classic_id(3102)]; for classic_id: int in [1609, 2504, 2609, 2611, 3111, 3112, 3410, 3709, 3711, 4310, 4713]: spells.append(library.content.spell_by_classic_id(classic_id))
