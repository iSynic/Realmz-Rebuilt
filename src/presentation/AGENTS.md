...
- Ordinary land travel draws the cataloged Classic foot-party CICN at its native 32×32 map-cell size. The abstract yellow ring is permitted only when that verified app-owned asset fails to load; boat, camp, horse, and directional variants require their own proven assets before use.
