...
- `runtime-unit`: VM tests cover Classic and Safe calls/returns, CODE 39/111/112, recursion and execution limits, typed Safe state, unknown behavior, interaction validation, and snapshot restore.
