...
- `journal_screen.tscn` owns the route shell and embeds `maps_notes_workspace.tscn`, whose visible Maps, Places, and Journal category rail selects scene-authored record-browser and detail panes. The current note editor retains separate controller-keyboard Done and Save Note operations.
