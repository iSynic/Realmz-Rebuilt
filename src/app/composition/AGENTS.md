...
- The combat Items handoff clears the interaction presenter before mounting the full Inventory workspace, so the battle command deck cannot cover or receive input behind Inventory. Returning through Done, Back, Escape, or cancelled targeting restores the existing battle presentation without reopening route audio.
