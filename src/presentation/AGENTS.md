...
- Campaign rows are availability summaries, not claims of full payload integrity. While the host validates a selected package, the library shows detached phase/progress data, disables competing Play actions, and exposes cooperative Cancel; presentation never opens archives or constructs content.
