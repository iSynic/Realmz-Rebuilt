...
- Large session, combat, application, interaction, and shell scripts were divided once, but 24 files still exceed the final 600-line limit, 95 functions exceed 60 lines, and 36 top-level scripts exceed the final method-count limits.
