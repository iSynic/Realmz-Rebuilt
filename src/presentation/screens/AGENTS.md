...
- The Allies workspace owns a separately backed current-ally list and detail pane. It renders current stamina, spell points, conditions, source identity, and exact CICN media from detached views, with an explicit empty state and no mutation path.
