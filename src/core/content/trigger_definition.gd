...
func _init(trigger_id: String, owner_map_id: String, trigger_coordinate: Vector2i, is_active: bool, chance: int, trigger_actions: Array[ClassicActionDefinition], trigger_replacement: TriggerReplacementDefinition = null) -> void:
	id = trigger_id
	map_id = owner_map_id
