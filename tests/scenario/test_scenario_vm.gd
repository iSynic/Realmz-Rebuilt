...
func run() -> void:
	...
	_test_public_application_transitions(content); _test_public_world_state_opcodes(content); _test_half_truth_random_water_branch(); _test_public_opcode_61_land_shift(content)
