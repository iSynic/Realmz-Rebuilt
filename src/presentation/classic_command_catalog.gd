...
const COMMANDS: Array[Dictionary] = [
	...
	{"id": &"heal", "group": &"world", "asset_id": &"", "input_action": &"realmz_heal", "contexts": [&"exploration"], "availability": &"heal", "label": "Heal", "tooltip": "Hold to spend 10 spell points per wounded recipient", "accelerator": "H", "focus_order": 45, "hold_repeat": true},
	{"id": &"contextual", "group": &"world", "asset_id": &"", "symbol": &"yin_yang", "input_action": &"", "contexts": [&"exploration"], "availability": &"contextual_encounter", "label": "Encounter", "tooltip": "Open the seamless encounter at this location", "accelerator": "E", "focus_order": 50},
