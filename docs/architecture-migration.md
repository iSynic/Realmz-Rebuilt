...
- Large session, combat, application, interaction, and shell scripts were divided once, but 27 files still exceed the final 600-line limit, 100 functions exceed 60 lines, and 37 top-level scripts exceed the final method-count limits.
