...
func _init(package_path: String = "", package_content: RealmzContent = null, package_media: PackageMediaCatalog = null, preparation_error: StringName = &"", preparation_message: String = "") -> void:
