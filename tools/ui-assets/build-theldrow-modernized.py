...
def build_pencil_glyph(
    ...
    _target_x_min, target_y_min, _target_x_max, target_y_max = bounds
...
def update_names(font: TTFont) -> None:
    ...
    values = {
        ...
        9: "Modernized letter contours curated in Pencil; Castle metrics preserved.",
        10: "Modernized derivative of Realmz Theldrow with Grenze Gotisch OFL utility outlines.",
