...
const COMMANDS: Array[Dictionary] = [
	...
	{"id": &"inventory", "asset_id": &"command.inventory", "input_action": &"ui_screen_inventory", "contexts": [&"exploration", &"character", &"inventory"], "availability": &"", "label": "Items", "tooltip": "Open party inventory", "accelerator": "I", "focus_order": 40},
	{"id": &"spells", "asset_id": &"command.spells", "input_action": &"ui_screen_spells", "contexts": [&"exploration", &"character", &"spells", &"combat"], "availability": &"", "label": "Spells", "tooltip": "Open known spells", "accelerator": "P", "focus_order": 50},
	{"id": &"maps", "asset_id": &"command.maps", "input_action": &"ui_screen_journal", "contexts": [&"exploration", &"journal"], "availability": &"", "label": "Maps", "tooltip": "Open acquired maps and notes", "accelerator": "M", "focus_order": 60},
	...
	{"id": &"settings", "asset_id": &"command.settings", "input_action": &"ui_screen_system", "contexts": [&"exploration", &"system"], "availability": &"", "label": "Preferences", "tooltip": "Open preferences and diagnostics", "accelerator": "", "focus_order": 80},
	{"id": &"temple", "asset_id": &"command.temple", "input_action": &"ui_screen_services", "contexts": [&"services"], "availability": &"", "label": "Temple", "tooltip": "Current temple service", "accelerator": "", "focus_order": 90},
