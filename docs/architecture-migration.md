...
- Large session, combat, application, interaction, and shell scripts were divided once, but 28 files still exceed the final 600-line limit, 102 functions exceed 60 lines, and 38 top-level scripts exceed the final method-count limits.
