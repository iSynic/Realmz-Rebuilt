...
- Authored LOS maps draw every exact save-owned seen cell at normal fidelity and cover only never-seen cells with the byte-exact project-owner fog tile. Current topology visibility may keep changing for gameplay and detached diagnostics, but leaving a cell's current LOS never conceals it again.
