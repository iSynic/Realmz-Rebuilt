...
func _capture_gallery() -> void:
	...
	_shell.controller.open_workspace_radial(); await _settle(); await _capture("canonical-controller-workspaces-wheel-1280x720"); _shell.controller.cancel_radial()
	_shell.controller.open_action_radial(); await _settle(); await _capture("canonical-controller-actions-wheel-1280x720"); _shell.controller.cancel_radial()
	await _resize(Vector2i(800, 600)); _shell.controller.open_workspace_radial(); await _settle(); await _capture("classic-controller-workspaces-wheel-800x600"); _shell.controller.cancel_radial(); await _resize(Vector2i(1280, 720))
