...
func _test_battle_typed_option_contracts() -> void:
	...
	var component := BattleInteraction.new(); component.theme = load("res://src/ui/classic_ui_theme.tres"); component.build(request)
