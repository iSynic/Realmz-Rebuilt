...
const EXECUTABLE_OPCODES: Array[int] = [
	...
	50, 60, 61, 62, 63, 64, 65, 66, 68, 69, 73, 74, 76, 77, 82, 83, 84, 86, 87, 90, 91, 95, 96, 97, 101, 102, 103, 105, 106, 108, 111, 112, 119, 120, 121, 122, 123, 124, 126, 127,
]
...
const PENDING_OPCODES: Array[int] = [
	41, 44, 53, 55, 57, 58, 59, 67, 70, 71, 72, 75, 78, 81, 85,
	92, 93, 94, 100, 125,
]
