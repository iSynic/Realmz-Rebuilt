...
- **major** `classic.spellcasting.combat-cast` - Manual, fixed-power scroll, charged-item, Party Auto, and monster casting share source-backed condition-cure, single-target friendly condition-effect, multi-actor ray, rotated-area, persistent-field, hostile-group, Flame Missile, and zero-cost breath resolution. Learned, fixed-power scroll, Party Auto, and monster sources also share summoning; charged-item summoning remains owned by the item-use gap. Every application spell has one mechanical-family and per-source disposition; only the remaining special-effect families stay explicit pending capabilities. Next: Implement charged-item special-58 summoning, then continue the remaining unresolved special-effect families while keeping every unavailable family explicit.
...
- `classic.spellcasting.combat-cast` - Manual, fixed-power scroll, charged-item, Party Auto, and monster casting share source-backed condition-cure, single-target friendly condition-effect, multi-actor ray, rotated-area, persistent-field, hostile-group, Flame Missile, and zero-cost breath resolution. Learned, fixed-power scroll, Party Auto, and monster sources also share summoning; charged-item summoning remains owned by the item-use gap. Every application spell has one mechanical-family and per-source disposition; only the remaining special-effect families stay explicit pending capabilities.
