...
- Complete Race and Caste arrays must contain functional Classic rule data. A structurally valid but semantically empty 30-record table is rejected before it can collapse derived character statistics.
