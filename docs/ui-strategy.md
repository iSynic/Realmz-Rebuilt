...
- Services use typed shop, temple, bank, and treasure requests. No location or operation is invented. A storage service may appear only if separately sourced as authored campaign behavior; it is not inferred from opcode 36 or Remake's Honest Storage.
