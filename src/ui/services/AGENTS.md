...
- `shop_interaction.tscn` owns the wide two-ledger and compact tabbed Shop compositions. Its script binds request-owned stock, packs, filters, offers, load, and exact typed responses through exported record scenes. Items and Money open the complete reusable application workspaces over the retained Shop; their contextual Back returns to the unchanged transaction, while conflicting mutations remain visibly unavailable until the player leaves the Shop.
