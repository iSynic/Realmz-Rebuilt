...
The standalone Character Files creator rebases workshop party item identities and equipped order to the stable Character File identity before publication, so each detached revision owns globally unique exact instances.
