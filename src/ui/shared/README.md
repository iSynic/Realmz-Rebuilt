...
Application-wide media lives under `assets/`. Feature-specific scene composition remains with its owning UI feature; shared code must not accumulate route-specific commands, gameplay rules, saved state, or package lookup.
