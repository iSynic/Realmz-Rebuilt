...
func _test_fixture_gallery_coverage() -> void:
	...
	var spell_component := LevelUpInteraction.new(); spell_component.build(ClassicUiFixtureGallery.request_for(InteractionRequest.LEVEL_UP, &"unidentified"))
