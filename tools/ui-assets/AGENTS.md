...
- Every integrated Classic WAV sidecar must select Godot's lossless PCM import mode. The verifier rejects lossy QOA or Vorbis transcoding even when the source WAV and manifest hashes remain exact.
