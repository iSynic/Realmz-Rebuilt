...
Next rolling priority: source-settle missile/melee weapon switching, point-blank behavior, attack replacement, and the tactical distance/facing state they require. Keep spell-per-activation and Castle's contradictory haste/display cases separate.
