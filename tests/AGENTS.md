...
- Exploration coverage proves the typed ordinary-movement presentation delta, hourly fatigue/spell/condition recovery's mutable-party refresh without a complete campaign reprojection, bounded inherited visibility, restore/LOS full-projection fallback, adjacent debug no-clip's incremental RNG-neutral transaction, and exact default versus host-requested detached map spans at map edges. Presentation suites retain map/shell composition ownership rather than testing private caches.
