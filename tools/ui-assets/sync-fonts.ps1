...
try {
    ...
    foreach ($obsoleteTarget in @(
        "Theldrow-CC0.ttf",
        "licenses/Theldrow-CC0-LICENSE.txt",
        "licenses/Theldrow-CC0-README.txt"
    )) {
    ...
    Write-Host "Bundled readable fonts and source-backed Classic typography assets from pinned sources."
}
finally {
