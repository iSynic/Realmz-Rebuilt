...
- `SessionMoneyWorkflow` owns Pool, Share, denomination transfers, and pooled money changing plus their event and movement recalculation boundaries.
...
- Use `EconomyRules` for denomination, affordability, capacity, Pool, Share, and Swap behavior, and `MoneyChangingRules` for conversion rates and pooled-wealth mutations; do not duplicate those calculations here.
...
- `tests/integration/test_money_workflow.gd` owns public Pool, Share, Swap, and money-changing transactions.
