...
- Its empty state renders the detached host notice when existing revisions are incompatible or invalid, instead of claiming that no Character Files exist.
