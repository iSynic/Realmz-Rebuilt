...
- `classic-compatibility-gap-register.md` tracks confirmed sub-workflow blockers, coverage gaps, reported ordinary-play defects, exposure counts, and closure evidence that the coarser generated workflow and opcode/spell denominators do not yet express.
