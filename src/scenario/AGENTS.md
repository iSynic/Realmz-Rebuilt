...
- Spatial combat spell options also carry the complete core-probed legal-center list. This is detached interaction data, not authored package content or save state; the runtime API serializes it without recalculating or broadening the set.
