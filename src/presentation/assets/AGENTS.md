...
- The licensed transparent Searching atlas remains byte-exact and records its eight-frame row in the manifest. Exact Torch frame files also remain byte-exact; presentation may key only the documented legacy neutral-gray matte colors while composing them onto Rebuilt chrome.
