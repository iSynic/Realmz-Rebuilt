...
5. Separate authored inactive rectangles from malformed active rectangles in Kalypso's Island and Spires of Steel.
6. Generate normalized Providence feature reports for the two opening-tested packages, then begin their ordinary save/resume routes only after AOGM and War retain priority.
