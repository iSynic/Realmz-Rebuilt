...
func _test_classic_choice_context() -> void:
	...
	assert_equal((encounter.find_child("EncounterChoiceGrid", true, false) as GridContainer).columns, 1, "the selected encounter command owns a compact vertical contextual response pane")
