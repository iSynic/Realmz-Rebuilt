...
func _test_scene_composition() -> void:
	...
	assert_not_null(shell.get_node_or_null("ScreenRouter"), "the shell owns one workspace router"); assert_not_null(shell.get_node_or_null("BottomRegion/BottomRow/NarrativeWell"), "the shell owns a narrative well")
