## Presents Classic command catalog through the Godot interface.
...
const COMMANDS: Array[Dictionary] = [
	...
	{"id": &"area_search", "group": &"world", "asset_id": &"command.area_search_visual", "art_region": [10, 5, 31, 21], "input_action": &"", "contexts": [&"exploration"], "availability": &"area_search", "label": "Area Search", "caption_lines": ["Area", "Search"], "tooltip": "Hold to search the nearby area", "accelerator": "", "focus_order": 15, "hold_repeat": true},
	...
	{"id": &"heal", "group": &"world", "asset_id": &"", "asset_path": "res://src/ui/shared/assets/ui/commands/heal.png", "art_region": [13, 18, 47, 40], "input_action": &"realmz_heal", "contexts": [&"exploration"], "availability": &"heal", "label": "Heal", "tooltip": "Hold to spend 10 spell points per wounded recipient", "accelerator": "H", "focus_order": 45, "hold_repeat": true},
