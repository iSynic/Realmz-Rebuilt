...
- Compiler evidence: Providence commit `a525e9df0d0619847a5928463eed881ace79152a` retains direct ally monster definitions and packages every referenced map atlas, including a normalized Classic dungeon composition atlas. Its 325-test Rust library gate passes with one audit test ignored. Runtime unit/integration coverage currently passes 757 assertions across nine suites.
- Current AOGM visual evidence: local package hash `737a84e374bfd3b843ce50e8176c648e33e8f68bb5894efb2a8b96693f0204d2` independently validates with 26 media assets. A 960×600 capture at land 0 (48,15) shows package-backed Classic tiles centered in a clipped 530×452 map viewport with Party, Chronicle, Day/Gold, minimap, and the complete command bar visible. This does not replace the earlier route package's `live-route` evidence until that route is rerun against the new hash.
