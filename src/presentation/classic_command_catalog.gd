...
const COMMANDS: Array[Dictionary] = [
	...
	{"id": &"heal", "group": &"world", "asset_id": &"", "asset_path": "res://src/presentation/assets/ui/commands/heal.png", "input_action": &"realmz_heal", "contexts": [&"exploration"], "availability": &"heal", "label": "Heal", "tooltip": "Hold to spend 10 spell points per wounded recipient", "accelerator": "H", "focus_order": 45, "hold_repeat": true},
