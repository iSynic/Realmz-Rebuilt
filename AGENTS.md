...
- Persist ordered equipped-instance identity in `.r2save` v5 and Character Files v2. Older save and character revisions are incompatible: report them without migration, inference, overwrite, or deletion.
