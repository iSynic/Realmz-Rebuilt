...
func _test_startup_shell() -> void:
	...
	assert_true(setup_workspace != null and setup_workspace.visible and not splash.visible and intro_animation.stream == null and not intro_animation.is_playing(), "scenario selection opens integrated setup and releases the hidden intro decoder and stream")
